        !COMPILER-GENERATED INTERFACE MODULE: Sat Mar 12 17:13:50 2016
        MODULE READ_MATERIALS__genmod
          INTERFACE 
            SUBROUTINE READ_MATERIALS(NB_MATERIALS,ICODEMAT,CP,CS,ANISO3&
     &,ANISO4,ANISO5,ANISO6,ANISO7,ANISO8,ANISO9,ANISO10,ANISO11,QKAPPA,&
     &QMU,RHO_S,RHO_F,PHI,TORTUOSITY,PERMXX,PERMXZ,PERMZZ,KAPPA_S,      &
     &KAPPA_F,KAPPA_FR,ETA_F,MU_FR)
