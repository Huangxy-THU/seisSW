...
! for a cleaner interface and for consistency with 3D packages, write one material parameter per binary file instead of three
  logical, parameter :: NEW_BINARY_FORMAT = .false.

! write DATA/proc***rho_vp_vs.dat_output files
